...
[RequireComponent(typeof(TextureObject))]
...
public class ObjectControl : MonoBehaviour
{
    ...
    private TextureObject m_TextureBehaviour;
    ...
    private void Awake()
    {
        m_TextureBehaviour = GetComponent<TextureObject>();
    ...
    public void OnTextureChange(InputAction.CallbackContext context)
    {
        if (!m_ActiveObject) return;
        if (!context.action.triggered) return;
